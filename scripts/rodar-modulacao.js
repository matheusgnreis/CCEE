...
const AGENTES = [
  "C CL CERAMICA TRANSCOR", "DOCE MINEIRO", "MARQUESPAN INDUSTRIA", "MARQUESPAN INDUSTRIA PR",
  "MARQUESPAN SANTA CRUZ", "PLASCAR", "SALINAS EXCLUSIVE",
  "USIMINAS BH AP", "UTE LD CELULOSE"
];
