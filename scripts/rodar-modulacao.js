...
const AGENTES = [
  "ACUMENT", "ARCOR", "ARCOR - RIO DAS PEDRAS", "AVIVAR",
  "CEBRACE", "CEMIG GERA CAMARGOS CONV", "CEMIG H COMERCIALIZACAO",
  "CIAFAL", "CIPALAM", "CONDUTEC", "IPANEMA AGRICOLA", "JUSSARA",
  "LACTALIS", "LPA", "MARTMINAS", "MELITTA", "MIDEA", "MIDEA MG",
  "PATIO SABIA", "SAE TOWERS", "SALITRE FERTILIZANTES", "SG DO BRASIL",
  "SUPER BH 001", "SUPERMERCADOS ABC", "SUPER SERRA AZUL", "TELHANORTE",
  "UBERLANDIAREF", "UTE WD", "VIBRA",
];
